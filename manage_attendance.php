		...
		<form action="" id="employee-attendance">
			<div class="row form-group">
				...
				<div class="col-md-3 mt-3">
					...
					<select id="type" name="type" class="borwser-default custom-select">
				...
				<div class="col-md-5 mt-3">
					...
					<input type="text" id="adate" class="form-control" value=" <?php
				...
				<div class="col-md-4 mt-3">
					...
					<button class="btn btn-primary btn-block btn-sm px-2" type="button" id="add_list"> Add to
						List</button>
				</div>
			</div>
		...
		<tr>
			...
			<td>
				...
				<p class="type">
					<?php 
					// $type = $_POST['type'];
					// $logtype = $conn->query("INSERT INTO `attendance` (`log_type`) VALUES ($type)"); ?>
				</p>
			</td>
			...
			<td class="text-center">
				<button class="btn-sm btn-danger" type="button" onclick="$(this).closest('tr').remove()"><i
